...
class TypesBuilderExtensionProvider {
	...
	@Inject IJvmModelAssociations _jvmModelAssociations;
	...
	def copyBuildersTo(TypesBuilderExtensionProvider typesBuilderExtensionProvider) {
		...
		typesBuilderExtensionProvider._jvmModelAssociations = _jvmModelAssociations;
	}

	def IJvmModelAssociations getJvmModelAssociations() {
		return _jvmModelAssociations;
	}
}
